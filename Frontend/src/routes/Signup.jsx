            ...
            <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
              <div className="g-0 lg:flex lg:flex-wrap">
                ...
                <div className="px-4 md:px-0 lg:w-6/12">
                  ...
                  <button onClick={googleSign} className="flex items-center w-full cursor-pointer justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <span className="w-3/6 px-3 py-3 font-bold text-center">Sign up with Google</span>
                  </button>
