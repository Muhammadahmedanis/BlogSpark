...
const ResetPassword = () => {
    ...
    const [user, submitAction, isPending] = useActionState(async (previousState, formData) => {
        ...
        try {
            ...
            // await axiosInstance.post(`/auth/change-password/${token}`, { oldPassword, newPassword })
            ...
            <main id="content" role="main" className="w-full max-w-md p-6">
                <div className="bg-white     shadow-lg mt-7 rounded-xl">
                    <div className="p-4 sm:p-7">
                            ...
                            {/* <h1 className="block text-lg font-bold text-center text-gray-800">Reset Password</h1> */}
                        <div className="">
                            <form action={submitAction}>
                                <div className="grid gap-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="inline-flex items-center cursor-pointer justify-center gap-2 px-4 py-3 text-sm font-semibold text-white transition-all bg-[#7f75dd] hover:bg-[#a09de8] border border-transparent rounded-md  focus:outline-none focus:ring-2">
                                        Change my password
