...
import { AllPost, createPost, deletePost, featuredPost, getMyBlog, getPostBySearchParams, getPosts, getSaveBlog} from "../controllers/post.controller.js";
...
postRouter.route("/create").post(verifyJwt, createRateLimiter(5 * 60 * 1000, 5, "Too much create post request hit, please try again after five minute"), upload.single("img"), createPost);
