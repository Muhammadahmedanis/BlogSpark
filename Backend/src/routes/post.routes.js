...
import { AllPost, createPost, deletePost, featuredPost, getPost, getPosts, uploadAuth } from "../controllers/post.controller.js";
...
postRouter.route("/allBlog").get(verifyJwt,AllPost);
