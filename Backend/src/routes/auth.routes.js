...
import { changeCurrentPassword, forgotPassword, getUserInfo, googleSignin, logout, refreshAccessToken, resendOtp, signin, signup, updateUser, verifyEmail } from "../controllers/auth.controller.js";
